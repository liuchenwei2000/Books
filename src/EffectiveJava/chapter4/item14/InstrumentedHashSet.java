...
public class InstrumentedHashSet<E> extends HashSet<E> {
	...
	/**
	 * 为每个元素依次调用add方法，这样可以保证得到正确的结果，
	 * 并且不用关心HashSet的addAll方法是否是在add方法上实现的。
	 * 但是它相当于重新实现了超类的方法，这种方式很困难、耗时、容易出错。
	 * 并且并不总是可行的，因为对于某些方法，它们无法访问对于子类来说是私有的域，这样的方法在子类中是无法重新实现的。
	 */
